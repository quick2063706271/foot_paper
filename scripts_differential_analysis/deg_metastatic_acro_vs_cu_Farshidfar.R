...
# ==============================================================================
# DESeq2 Analysis: Metastatic Samples - Acral vs SunExposed
# ==============================================================================

# Filter to metastatic samples only
coldata_metastatic <- coldata %>% 
  dplyr::filter(Site.of.tumor.sampling == "Metastatic")

cts_metastatic <- cts[, rownames(coldata_metastatic)]

# Create DESeq2 dataset
dds <- DESeqDataSetFromMatrix(
  countData = cts_metastatic,
  colData = coldata_metastatic,
...
# saveRDS(dds, glue("{out_dir}/deseq_objects/metastatic_all_Acral_vs_SunExposed.rds"))
# dds <- readRDS(glue("{out_dir}/deseq_objects/metastatic_all_Acral_vs_SunExposed.rds"))

# ==============================================================================
# PCA Plot
# ==============================================================================

generate_pca_plot(dds, "metastatic_all_Acral_vs_SunExposed", intgroup = "Subtype")
...
res_sorted <- extract_results_by_name(
  ...
  output_name = "metastatic_all_Acral_vs_SunExposed"
)
...
generate_volcano_plot(
  ...
  output_name = "metastatic_acro_vs_cutaneous_volcano_plot",
  plot_title = "Metastatic Acral vs Cutaneous RNAseq\nDifferential Analysis"
)