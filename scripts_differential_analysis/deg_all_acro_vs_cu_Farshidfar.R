...
# ==============================================================================
# DESeq2 Analysis: Acral vs SunExposed
# ==============================================================================
...
# saveRDS(dds, glue("{out_dir}/deseq_objects/all_Acral_vs_SunExposed.rds"))
# dds <- readRDS(glue("{out_dir}/deseq_objects/all_Acral_vs_SunExposed.rds"))

# ==============================================================================
# PCA Plot
# ==============================================================================

generate_pca_plot(dds, "all_Acral_vs_SunExposed", intgroup = "Subtype")
...
res_sorted <- extract_results_by_name(
  ...
  output_name = "all_Acral_vs_SunExposed"
)
...
generate_volcano_plot(
  ...
  output_name = "all_acro_vs_cutaneous_volcano_plot",
  plot_title = "All Acral vs Cutaneous RNAseq\nDifferential Analysis"
)