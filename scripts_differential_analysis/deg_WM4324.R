...
extract_results_by_contrast <- function(dds, contrast_vec, output_name) {
  ...
  res_filtered <- res[complete.cases(res$padj), ]
...
# Load count data
count_data_file <- "~/Documents/rebecca_lab/acral_melanoma/data/raw_count/WM4324_raw_counts.csv"
...
coldata <- data.frame(
  cond = c("foot", "foot", "foot", "foot", "back", "back", "back", "back"),
  row.names = colnames(count_data)
)

# ==============================================================================
# DESeq2 Analysis: WM4324 Foot vs Back
# ==============================================================================
...
# saveRDS(dds, glue("{out_dir}/deseq_objects/WM4324.rds"))
# dds <- readRDS(glue("{out_dir}/deseq_objects/WM4324.rds"))
...
res_sorted <- extract_results_by_contrast(
  ...
  output_name = "WM4324_foot_vs_back"
)
...
generate_volcano_plot_custom(
  ...
  output_name = "WM4324",
  plot_title = "WM4324 Foot vs Flank"
)